...
(function() {
            ...
            Ext.ComponentMgr.onAvailable('component-add-menu', function(config) {
                ...
                menuButton.menuItems.push({
                    xtype: 'menuitem',
                    text: _t('Add JBoss JGroup') + '...',
                    hidden: Zenoss.Security.doesNotHavePermission('Manage Device'),
                    handler: function() {
                        var win = new Zenoss.dialog.CloseDialog({
                            width: 300,
                            title: _t('Add JBoss JGroup'),
                            items: [{
                                xtype: 'form',
                                buttonAlign: 'left',
                                monitorValid: true,
                            ...
                            }, 
                            {
                                ...
                                buttons: [{
                                    xtype: 'DialogButton',
                                    id: 'zenJavaJBoss-submit',
                                    text: _t('Add'),
                                    formBind: true,
                                    handler: function(b) {
                                        var form = b.ownerCt.ownerCt.getForm();
                                        var opts = form.getFieldValues();
                                        Zenoss.remote.zenJavaJBossRouter.addJBossJGroupClusterRouter(opts,
                                        function(response) {
                                            if (response.success) {
                                                new Zenoss.dialog.SimpleMessageDialog({
                                                    title: _t('JBoss JGroup Added'),
